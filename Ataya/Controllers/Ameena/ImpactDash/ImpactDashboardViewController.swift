...
<<<<<<< HEAD:Ataya/Controllers/Ameena/ImpactDash/ImpactDashboardViewController.swift
    private var donations: [ImpactDonation] = []

=======
    private var donations: [Donation] = []
    
>>>>>>> 83983a9fa934c5cad58bacad6f7ff1b6273b3ef3:Ataya/Controllers/Ameena/ImpactDashboardViewController.swift
...
=======
    ...
    //
    //                let docs = snap?.documents ?? []
    //                //self.donations = docs.compactMap { Donation(doc: $0) }
    //
    //                // Recalculate impact whenever data changes
    //                self.updateImpactNumbers()
    //            }
