...
final class GiftOfMercyHubViewController: UIViewController {
    ...
    private let row2Container = UIView()   // كونتينر للسطر الثاني
    ...
    private func setupUI() {
        ...
        // row2: container وفي النص Card Designs
