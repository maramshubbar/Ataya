...
final class RecurringConfirmLocationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // Fallback if GPS is unavailable (demo-safe)
    ...
    @IBAction func confirmTapped(_ sender: Any) {
        ...
        LocationStorage.save(latitude: coord.latitude,
...
extension RecurringConfirmLocationViewController: CLLocationManagerDelegate {
...
extension RecurringConfirmLocationViewController: MKMapViewDelegate {
